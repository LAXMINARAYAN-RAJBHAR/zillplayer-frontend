...
const SuggestionCard = ({ item, isActive, onClick, isMobile }) => {
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (!isActive && hasYTId) e.currentTarget.style.background = "#1a1a1a";
      }}
      onMouseLeave={(e) => {
      ...
      >
        ...
        {isActive && (
          ...
          >
            ...
            >
              <span
                style={{ fontSize: "10px", marginLeft: "2px", color: "#000" }}
              >
                ▶
              </span>
            </div>
...
`}</style>
        <div className="hp-watch-root">
          {/* Slim top bar — no back button needed, navbar is visible */}
          <div
            style={{
              display: "flex",
              alignItems: "center",
  ...
  return (
    <>
      ...
      <div
        style={{
          position: "fixed",
          top: "55px" /* ← match your navbar height exactly */,
          left: "0",
          right: "0",
          bottom: "0",
          zIndex: 999 /* ← lower than navbar's z-index */,
          background: "#0f0f0f",
          display: "flex",
                ...
                <React.Fragment key={rowIndex}>
                  ...
                  {filteredVideos.slice(vStart, vEnd).length > 0 && (
                    <div className="youtube_VideoGrid">
                      {filteredVideos.slice(vStart, vEnd).map((v) => (
